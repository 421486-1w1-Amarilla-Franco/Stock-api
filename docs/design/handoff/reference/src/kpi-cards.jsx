...
const KpiCards = ({ kpis, ventasDiarias }) => {
  const cards = [
    ...
    },
    {
      ...
      value: fmtARS(Math.round(kpis.ticketPromedio)),
      delta: <Delta value={kpis.ticketPromedioDelta} />,
      sub: `${kpis.ventasHoy} venta${kpis.ventasHoy === 1 ? "" : "s"} hoy`,
    },
  ];
